...
from apps.revision.views import RevisionList, Revision2List, BuscarView, RevisionCreate,\
	 RevisionUpdate, Revision2Update, Revision3Update, RevisionDelete, RevisionVisualizar
...
urlpatterns = [
    ...
    url(r'^visualizar/(?P<pk>\d+)$', login_required(RevisionVisualizar.as_view()), name='visualizar'),
]
